const mockDestinations = [
  ...
  },
  {
    ...
    description: 'Amsterdam is called the "Venice of the North" because of the many canals, of which there are more than 100 kilometers, about 90 islands and 1,500 bridges. The city is known for such attractions as the Rijksmuseum, the Vincent Van Gogh Museum, the City Museum, and the red light district.',
    name: 'Amsterdam',
    pictures: [
      {
        src: 'http://picsum.photos/300/200?r=0.0762563005163317',
